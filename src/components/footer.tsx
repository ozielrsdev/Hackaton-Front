  ...
  return (
    <footer className="w-full py-14">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl flex items-center flex-col justify-center mx-auto">
          <img src={logo} className="w-10 h-10" alt="" />
          <ul className="text-lg flex items-center justify-center flex-col gap-7 md:flex-row md:gap-12 transition-all duration-500 py-6 mb-10 border-b border-gray-200">
            <li>
          ...
          <span className="text-lg text-gray-500 text-center block">
            ©<a href="#">Squad - 5</a> 2024, All rights reserved.
          </span>
        </div>
      </div>
    </footer>
